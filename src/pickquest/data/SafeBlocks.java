...
public class SafeBlocks {
	...
	@SuppressWarnings("deprecation")
	private EnumSet<Material> safeAt = EnumSet.of(Material.WHEAT, Material.GRASS, Material.AIR, Material.CAVE_AIR, Material.LEGACY_AIR, Material.WATER, Material.OAK_SAPLING,
